...
class Tool {
    ...
    elseif (isset($_SERVER['HTTPS']) AND (strtolower($_SERVER['HTTPS']) === 'on' OR $_SERVER['HTTPS'] === 1)): return TRUE;

    elseif (isset($_SERVER['HTTP_X_FORWARDED_PROTO']) AND strtolower($_SERVER['HTTP_X_FORWARDED_PROTO']) === 'https'): return TRUE;

    elseif (isset($_SERVER['HTTP_FRONT_END_HTTPS']) AND (strtolower($_SERVER['HTTP_FRONT_END_HTTPS']) === 'on' OR $_SERVER['HTTP_FRONT_END_HTTPS'] === 1)): return TRUE;
